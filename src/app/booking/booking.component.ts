...
export class BookingComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private snackBar: MatSnackBar, private router: Router, private inmateService: InmateService) { }
  ...
  public onSubmit(): void {
    ...
    const { firstName, surname, dob, arrivalDate, arrivalTime } = this.bookingForm.value;
    const inmate: Inmate = {
      id: null,
